...
**Design Aesthetic**: Lumière minimal, classy, card-based layout with clean white cards, soft shadows, Font Awesome v6 icons. Responsive grid system (3 columns desktop, 2 tablet, 1 mobile).

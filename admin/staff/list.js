      ...
      if (member.staff_image) {
        ...
        if (imagePreview) {
          ...
          imagePreview.onerror = () => {
            console.warn(
              "Staff image missing or unreadable:",
              member.staff_image
            );
            if (imagePreviewContainer) {
              imagePreviewContainer.style.display = "none";
            ...
            if (previewFileName) {
              const fileName =
                member.staff_image.split("/").pop() || "Image not found";
      ...
      try {
        ...
        if (errorData.error?.details) {
          ...
          if (errorData.error.details.first_name) {
            errorMessages.push(
              "First Name: " + errorData.error.details.first_name
            );
          }
          if (errorData.error.details.last_name) {
            errorMessages.push(
              "Last Name: " + errorData.error.details.last_name
            );
          }

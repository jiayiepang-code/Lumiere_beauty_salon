...
async function viewBookingDetails(bookingId) {
  ...
  try {
    ...
    if (data.success) {
      // Store booking ID for potential reload
      if (content) {
        content.dataset.bookingId = bookingId;
      }
...
// Get allowed roles for a service category
function getRolesForServiceCategory(serviceCategory) {
